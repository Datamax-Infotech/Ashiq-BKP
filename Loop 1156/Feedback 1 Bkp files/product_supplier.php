		...
		<div class="col-md-2 inventory-filter">
			...
			<div class="col-md-12 filter-box2">
				<div class="row">
					...
					<div class="form-group col-md-12">
						...
						<div class="row">
							<div class="col-sm-5 form-group m-0">
								<input name="min_length" type="number" class="w-100" value="0" min="0" max="99" id="length-from" onblur="show_inventories('',1)"/>
							</div>
							<div class="col-sm-2">
								-
							</div>
							<div class="col-sm-5 form-group m-0">
								<input name="max_length" type="number" class="w-100" value="99" min="0" max="99" id="length-to" onblur="show_inventories('',1)"/>
							</div>
						</div>
					</div>
					<div class="form-group col-md-12">
						...
						<div class="row">
							<div class="col-sm-5 form-group m-0">
								<input name="min_width" type="number" class="w-100" value="0" min="0" max="99" id="width-from" onblur="show_inventories('',1)"/>
							</div>
							<div class="col-sm-2">
								-
							</div>
							<div class="col-sm-5 form-group m-0">
								<input name="max_width" type="number" class="w-100" value="99" min="0" max="99" id="width-to" onblur="show_inventories('',1)"/>
							</div>
						</div>
					</div>
					<div class="form-group col-md-12">
					...
					<div class="form-group col-md-12">
						<label class="font-weight-bold">Cubic Footage</label>
						<div class="row">
							<div class="col-sm-5 form-group m-0">
								<input name="min_cubic_footage" type="number" class="w-100" value="0.00" min="0.00" max="99.99" id="cubic_footage-from" onblur="show_inventories('',1)"/>
							</div>
							<div class="col-sm-2">
								-
							</div>
							<div class="col-sm-5 form-group m-0">
								<input name="max_cubic_footage" type="number" class="w-100" value="99.99" min="0.00" max="99.99" id="cubic_footage-to" onblur="show_inventories('',1)"/>
							</div>
						</div>
					</div>
					...
					<div class="form-group col-md-12">
						...
						<select class="w-100" name="ect_burst" id="ect_burst" onchange="show_inventories('',1)">
							...
							<option value="ECT" display_val="ECT">ECT</option>
							<option value="Burst" display_val="Burst">Burst</option>
						</select>
					</div>
					</form>
				</div>
...
<script>
	...
	function show_inventories(reset_form="", filter=""){
		...
		if(ect_burst_display_val || ect_burst==""){	
