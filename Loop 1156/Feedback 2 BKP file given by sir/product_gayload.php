					...
					$.each(result,function(index,res){
						...
						result_str +=`<tr>	
										<td width='50px' id="after_po${index}">
											<a href="javascript:void(0)" onclick="display_preoder_sel(${index}, ${res['reccnt']}, ${res['loop_id']}, ${res['box_warehouse_id']})"><u>${res['qtyAvailable']}</u></a>
										</td>
										...
										<td width='300px'><a class="text-primary" target="_blank" href="manage_box_b2bloop.php?id=${res['loop_id']}&proc=View&"><u>${res['system_description']}</u></a></td>
										<td width='150px'>${res['supplier_name']}</td>
										<td width='150px'>${res["shipFromLocation"]}</td>
									</tr>`;
