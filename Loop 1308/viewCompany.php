...
<head>
  ...
  pre {
	...
	.white_content_gaylord_v3_child{
		display: none;
		position: absolute;
		border: 1px solid gray;
		background-color: white;
...
<script language="javascript">
    ...
    function update_po_delivery_dt(trans_rec_id)
	{
		...
		xmlhttp.open("GET","planned_deliverydt_update.php?trans_rec_id=" +trans_rec_id+"&planned_delivery_dt="+po_delivery_dt_tmp,true);
		xmlhttp.send();
	}		
	...
	{ 
        document.getElementById("div_inv_items1").innerHTML  = "<br/><div style='text-align: center;'>Loading .....<img src='images/wait_animated.gif' /></div>"; 
		...
		xmlhttp.open("POST","search_result_show_include_box.php?id="+wid+"&comid="+comid+"&rectype="+rectype,true);
		xmlhttp.send();
	}	
		...
		xmlhttp.onreadystatechange=function()
		{
		  if (xmlhttp.readyState==4 && xmlhttp.status==200)
		  {
			...
			document.getElementById("divBoxShipRescue_child_edit"+ctrlid).style.display = 'none';
			  $( "#divBoxShipRescue_child"+ctrlid ).load(window.location.href + " #divBoxShipRescue_child"+ctrlid );
		  }
		}

		xmlhttp.open("POST","editTables_dynamic_new.php?boxrescue_edit=yes&companyid="+compid+"&shipping_box_id="+shipping_box_id+"&ctrlid="+ctrlid+"&wall="+wall+"&box_condition="+box_condition+"&req_another_box="+req_another_box+"&frequency="+frequency+"&quantity="+quantity+"&s_box_size_id="+s_box_size_id+"&s_length="+s_length+"&s_width="+s_width+"&s_height="+s_height,true);			
		xmlhttp.send();
	}
	//
	//Gaylord edit
...
var pallet_boxid=document.getElementById("pallet_boxid"+ctrlid).value;
	...
	function onsubmitform_quotepo() 
	{
		...
		if (document.getElementById("po_delivery_dt").value == ""){
			msgstr = msgstr + "Planned Delivery Date\r\n";
		}
		if (document.getElementById("add_freight").value == ""){
			msgstr = msgstr + 'Please select an option for "Add Freight line to invoice".\r\n';
		}
	...
	{ 
		...
		xmlhttp.open("POST","fckeditor_email_sendrecordlink_publichandoff.php?companyID="+compid+"&employeed="+employeed,true);			
		xmlhttp.send();
	}
	...
	{ 
		...
		xmlhttp.open("POST","fckeditor_email_sendrecordlink.php?companyID="+compid+"&employeed="+employeed,true);			
		xmlhttp.send();
	}
	...
	function quotaitem(id,boxid) {
		...
		document.getElementById("light_quota").innerHTML  = "<br/><div style='text-align: center;'>Loading .....<img src='images/wait_animated.gif' /></div>"; 			
	...
	{ 
		...
		//{
			...
			sstr = sstr + "<select class='basic_style' name='sort_g_tool' id='sort_g_tool' onChange='display_new_gaylords_child(" + id + "," + this.value + "," + boxid + "," + n_left + "," + n_top + ")'><option value='1'";
	...
	function display_request_gaylords_test_new1(id, boxid, flg, viewflg, client_flg, load_all = 0) 
	{ 
		...
		sstr = sstr + "&nbsp;&nbsp;&nbsp;<select class='basic_style' name='g_timing' id='g_timing' onChange='display_request_gaylords_child_test_new1(" + id + "," + flg + "," + boxid + "," + viewflg + "," + client_flg + "," + n_left + "," + n_top + ")'><option value='1'";
        ...
        sstr = sstr + "&nbsp;Status&nbsp;<br>"; 
		sstr = sstr + "<select class='basic_style' name='sort_g_tool' id='sort_g_tool' onChange='display_request_gaylords_child_test_new1(" + id + "," + flg + "," + boxid + "," + viewflg + "," + client_flg + "," + n_left + "," + n_top + ")'><option value='1'";
		...
		sstr = sstr + "<select class='basic_style' name='sort_g_tool2' id='sort_g_tool2' onChange='display_request_gaylords_child_test_new1(" + id + "," + flg + "," + boxid + "," + viewflg + "," + client_flg + "," + n_left + "," + n_top + ")'><option value='1'";
		...
		if(client_flg!=1)
		{
			sstr = sstr + "<select class='basic_style' name='sort_g_view' id='sort_g_view' onChange='display_request_gaylords_child_test_new1(" + id + "," + flg + "," + boxid + "," + viewflg + "," + client_flg + "," + n_left + "," + n_top + ")'><option value='1'";
			if(viewflg==1){
			   sstr = sstr + " selected ";
			} 
			...
			sstr = sstr + "<select class='basic_style' name='sort_g_view' id='sort_g_view' onChange='display_request_gaylords_child_test_new1(" + id + "," + flg + "," + boxid + "," + viewflg + "," + client_flg + "," + n_left + "," + n_top + ")'><option value='2'";
			if(viewflg==2){
			   sstr = sstr + " selected ";
			}  
			sstr = sstr +">Customer Facing View</option></select>";
		...
		sstr = sstr +"<select class='basic_style' name='sort_g_location' id= 'sort_g_location' onChange='display_request_gaylords_child_test_new1(" + id + "," + flg + "," + boxid + "," + viewflg + "," + client_flg + "," + n_left + "," + n_top + ")' > "; 
		...
		sstr = sstr + "<input type='checkbox' name='' id='canship_ltl' onChange='display_request_gaylords_child_test_new1(" + id + "," + flg + "," + boxid + "," + viewflg + "," + client_flg + "," + n_left + "," + n_top + ")'>";
		sstr = sstr + "&nbsp;&nbsp;Can Ship LTL Only <br>";
		
		sstr = sstr + "<input type='checkbox' name='customer_pickup_allowed' id='customer_pickup_allowed' onChange='display_request_gaylords_child_test_new1(" + id + "," + flg + "," + boxid + "," + viewflg + "," + client_flg + "," + n_left + "," + n_top + ")'>";
    ...
    function display_request_gaylords_child_test_new1(id, flg, boxid, viewflg, client_flg, n_left,n_top) 
	{ 
        var flgs = document.getElementById("sort_g_tool").value;
        ...
        sstr = sstr + "Timing&nbsp;<br>";
		sstr = sstr + "<select class='basic_style' name='g_timing' id='g_timing' onChange='display_request_gaylords_child_test_new1(" + id + "," + this.value + "," + boxid + "," + viewflgs + "," + client_flg + "," + n_left + "," + n_top + ")'><option value='1'";
		...
		sstr = sstr + "<select class='basic_style' name='sort_g_tool' id='sort_g_tool' onChange='display_request_gaylords_child_test_new1(" + id + "," + this.value + "," + boxid + "," + viewflgs + "," + client_flg + "," + n_left + "," + n_top + ")'><option value='1'";
		...
		sstr = sstr + "<select class='basic_style' name='sort_g_tool2' id='sort_g_tool2' onChange='display_request_gaylords_child_test_new1(" + id + "," + this.value + "," + boxid + "," + viewflgs + "," + client_flg + "," + n_left + "," + n_top + ")'><option value='1'";
		...
		if(client_flg!=1)
		{
			sstr = sstr + "<select class='basic_style' name='sort_g_view' id='sort_g_view' onChange='display_request_gaylords_child_test_new1(" + id + "," + flgs + "," + boxid + "," + this.value + "," + client_flg + "," + n_left + "," + n_top + ")'><option value='1'";
			if(viewflgs==1){
			   sstr = sstr + " selected ";
			} 
			sstr = sstr +">UCB View</option><option value='2'";
			...
			sstr = sstr + "<select class='basic_style' name='sort_g_view' id='sort_g_view' onChange='display_request_gaylords_child_test_new1(" + id + "," + flgs + "," + boxid + "," + this.value + "," + client_flg + "," + n_left + "," + n_top + ")'><option value='2'";
...
//
			...
			xmlhttp.open("GET","quote_request_gaylords_new.php?ID="+id+"&gbox="+boxid+"&display-allrec="+flg+"&display_view="+viewflg+"&sort_g_tool2="+flg+"&load_all="+load_all,true);			
			xmlhttp.send();
		//}
		/*else 
		{
...
//New code
		...
		xmlhttp.open("GET","quote_request_gaylords_new.php?ID="+id+"&gbox="+boxid+"&display-allrec="+flgs+"&display_view="+viewflgs+"&g_timing="+g_timing+"&sort_g_tool2="+ sort_g_tool2,true);			
		xmlhttp.send();
	}
	...
	{ 
		...
		sstr = sstr + "Timing&nbsp;&nbsp;";
		sstr = sstr + "<select class='basic_style' name='g_timing_shipping' id='g_timing_shipping' onChange='display_request_shipping_child(" + id + "," + flg + "," + boxid + "," + viewflg + "," + n_left + "," + n_top + ")'><option value='1'";
		...
		sstr = sstr + "<select class='basic_style' name='sort_g_tool_shipping' id='sort_g_tool_shipping' onChange='display_request_shipping_child(" + id + "," + flg + "," + boxid + "," + viewflg + "," + n_left + "," + n_top + ")'><option value='1'";
...
//
		...
		sstr = sstr + "<select class='basic_style' name='sort_g_tool_shipping2' id='sort_g_tool_shipping2' onChange='display_request_shipping_child(" + id + "," + flg + "," + boxid + "," + viewflg + "," + n_left + "," + n_top + ")'><option value='1' ";
		...
		sstr = sstr + "<select class='basic_style' name='sort_g_view_shipping' id='sort_g_view_shipping' onChange='display_request_shipping_child(" + id + "," + flg + "," + boxid + "," + this.value + "," + n_left + "," + n_top + ")'><option value='1' ";
		if(viewflg==1){
		   sstr = sstr + " selected ";
		} 
		sstr = sstr +">UCB View</option><option value='2'";
		...
		xmlhttp.open("GET","quote_request_shipping_tool_new.php?ID="+id+"&gbox="+boxid+"&display-allrec="+flg+"&display_view="+viewflg+"&sort_g_tool2="+flg+"&load_all="+load_all,true);			
		xmlhttp.send();
	}		
...
//new code		  
            sstr = sstr + "Timing&nbsp;&nbsp;";
			sstr = sstr + "<select class='basic_style' name='g_timing_shipping' id='g_timing_shipping' onChange='display_request_shipping_child(" + id + "," + flgs + "," + boxid + "," + viewflgs + "," + n_left + "," + n_top + ")'><option value='1'";
			...
			sstr = sstr + "<select class='basic_style' name='sort_g_tool_shipping' id='sort_g_tool_shipping' onChange='display_request_shipping_child(" + id + "," + flgs + "," + boxid + "," + viewflgs + "," + n_left + "," + n_top + ")'><option value='1'";
...
//
			...
			sstr = sstr + "<select class='basic_style' name='sort_g_tool_shipping2' id='sort_g_tool_shipping2' onChange='display_request_shipping_child(" + id + "," + flgs + "," + boxid + "," + viewflgs + "," + n_left + "," + n_top + ")'><option value='1'";
			...
			sstr = sstr + "<select class='basic_style' name='sort_g_view_shipping' id='sort_g_view_shipping' onChange='display_request_shipping_child(" + id + "," + flgs + "," + boxid + "," + this.value + "," + n_left + "," + n_top + ")'><option value='1'";
			if(viewflgs==1){
			   sstr = sstr + " selected ";
			} 
			sstr = sstr +">UCB View</option><option value='2'";
...
//New code
		...
		xmlhttp.open("GET","quote_request_shipping_tool_new.php?ID="+id+"&gbox="+boxid+"&display-allrec="+flgs+"&display_view="+viewflgs+"&g_timing="+g_timing_shipping+"&sort_g_tool2="+ sort_g_tool_shipping2,true);			
		xmlhttp.send();
	}	
	...
	{ 
            ...
            sstr = sstr + "Timing&nbsp;&nbsp;";
			sstr = sstr + "<select class='basic_style' name='g_timing_supersack' id='g_timing_supersack' onChange='display_request_supersack_child(" + id + "," + flg + "," + boxid + "," + viewflg + "," + n_left + "," + n_top + ")'><option value='1'";
			...
			sstr = sstr + "<select class='basic_style' name='sort_g_tool_supersack' id='sort_g_tool_supersack' onChange='display_request_supersack_child(" + id + "," + flg + "," + boxid + "," + viewflg + "," + n_left + "," + n_top + ")'><option value='1'";
...
//
			...
			sstr = sstr + "<select class='basic_style' name='sort_g_tool_supersack2' id='sort_g_tool_supersack2' onChange='display_request_supersack_child(" + id + "," + flg + "," + boxid + "," + viewflg + "," + n_left + "," + n_top + ")'><option value='1'";
			...
			sstr = sstr + "<select class='basic_style' name='sort_g_view_supersack' id='sort_g_view_supersack' onChange='display_request_supersack_child(" + id + "," + flg + "," + boxid + "," + viewflg + "," + n_left + "," + n_top + ")'><option value='1'";
			if(viewflg==1){
			   sstr = sstr + " selected ";
			} 
			sstr = sstr +">UCB View</option><option value='2'";
...
//new code		  
            sstr = sstr + "Timing&nbsp;&nbsp;";
			sstr = sstr + "<select class='basic_style' name='g_timing_supersack' id='g_timing_supersack' onChange='display_request_supersack_child(" + id + "," + flgs + "," + boxid + "," + viewflgs + "," + n_left + "," + n_top + ")'><option value='1'";
			...
			sstr = sstr + "<select class='basic_style' name='sort_g_tool_supersack' id='sort_g_tool_supersack' onChange='display_request_supersack_child(" + id + "," + flgs + "," + boxid + "," + viewflgs + "," + n_left + "," + n_top + ")'><option value='1'";
...
//
			...
			sstr = sstr + "<select class='basic_style' name='sort_g_tool_supersack2' id='sort_g_tool_supersack2' onChange='display_request_supersack_child(" + id + "," + flgs + "," + boxid + "," + viewflgs + "," + n_left + "," + n_top + ")'><option value='1'";
			...
			sstr = sstr + "<select class='basic_style' name='sort_g_view_supersack' id='sort_g_view_supersack' onChange='display_request_supersack_child(" + id + "," + flgs + "," + boxid + "," + viewflgs + "," + n_left + "," + n_top + ")'><option value='1'";
			if(viewflgs==1){
			   sstr = sstr + " selected ";
			} 
			sstr = sstr +">UCB View</option><option value='2'";
		...
		xmlhttp.open("GET","quote_req_supersacks_matching_new.php?ID="+id+"&gbox="+boxid+"&display-allrec="+flgs+"&display_view="+viewflgs+"&g_timing="+g_timing_supersack+"&sort_g_tool2="+ sort_g_tool_supersack2,true);			
		xmlhttp.send();
	}
    ...
    function display_request_Pallet_tool(id, flg, viewflg, boxid, pallet_height=0, pallet_width=0, ctrlid =0, load_all = 0) 
	{ 
		...
		sstr = sstr + "Timing&nbsp;&nbsp;";
		sstr = sstr + "<select class='basic_style' name='g_timing_pallet' id='g_timing_pallet' onChange='display_request_pallet_child(" + id + "," + flg + "," + boxid + "," + viewflg + "," + n_left + "," + n_top + "," + pallet_height + "," + pallet_width + "," + ctrlid + ")'><option value='1'";
		...
		sstr = sstr + "<select class='basic_style' name='sort_g_tool_pallet' id='sort_g_tool_pallet' onChange='display_request_pallet_child(" + id + "," + flg + "," + boxid + "," + viewflg + "," + n_left + "," + n_top + "," + pallet_height + "," + pallet_width + "," + ctrlid + ")'><option value='1'";
		...
		sstr = sstr + "<select class='basic_style' name='sort_g_tool_pallet2' id='sort_g_tool_pallet2' onChange='display_request_pallet_child(" + id + "," + flg + "," + boxid + "," + viewflg + "," + n_left + "," + n_top + "," + pallet_height + "," + pallet_width + "," + ctrlid + ")'><option value='1'";
		...
		sstr = sstr + "<select class='basic_style' name='sort_g_view_pallet' id='sort_g_view_pallet' onChange='display_request_pallet_child(" + id + "," + flg + "," + boxid + "," + this.value + "," + n_left + "," + n_top + "," + pallet_height + "," + pallet_width + "," + ctrlid + ")'><option value='1'";
		if(viewflg==1){
		   sstr = sstr + " selected ";
		} 
		sstr = sstr +">UCB View</option><option value='2'";
    ...
    function display_request_pallet_child(id, flg, boxid, viewflg, n_left,n_top, pallet_height=0, pallet_width=0, ctrlid =0) 
	{ 
...
//new code		  
            sstr = sstr + "Timing&nbsp;&nbsp;";
			sstr = sstr + "<select class='basic_style' name='g_timing_pallet' id='g_timing_pallet' onChange='display_request_pallet_child(" + id + "," + flgs + "," + boxid + "," + viewflgs + "," + n_left + "," + n_top + "," + pallet_height + "," + pallet_width + "," + ctrlid + ")'><option value='1'";
			...
			sstr = sstr + "<select class='basic_style' name='sort_g_tool_pallet' id='sort_g_tool_pallet' onChange='display_request_pallet_child(" + id + "," + flgs + "," + boxid + "," + viewflgs + "," + n_left + "," + n_top + "," + pallet_height + "," + pallet_width + "," + ctrlid + ")'><option value='1'";
...
//
			...
			sstr = sstr + "<select class='basic_style' name='sort_g_tool_pallet2' id='sort_g_tool_pallet2' onChange='display_request_pallet_child(" + id + "," + flgs + "," + boxid + "," + viewflgs + "," + n_left + "," + n_top + "," + pallet_height + "," + pallet_width + "," + ctrlid + ")'><option value='1'";
			...
			sstr = sstr + "<select class='basic_style' name='sort_g_view_pallet' id='sort_g_view_pallet' onChange='display_request_pallet_child(" + id + "," + flgs + "," + boxid + "," + viewflgs + "," + n_left + "," + n_top + "," + pallet_height + "," + pallet_width + "," + ctrlid + ")'><option value='1'";
			if(viewflgs==1){
			   sstr = sstr + " selected ";
			} 
			sstr = sstr +">UCB View</option><option value='2'";
	...
	function addgaylord(companyid,inventoryid)
	{
		...
		if (document.getElementById('sales_price'+inventoryid)){
			sPrice = document.getElementById('sales_price'+inventoryid).value;
		}	
		
		if (document.getElementById('ship_final'+inventoryid)){
			sFinal = document.getElementById('ship_final'+inventoryid).value;
		}
		...
		xmlhttp.onreadystatechange=function()
		{
			...
			{	
				...
				alert("Item " + inventoryid + " added to the cart");
			}
		}
		xmlhttp.open("POST","box_quoting_mrg_mysqli.php?ID="+ companyid +"&inventoryID="+ inventoryid +"&sales_price="+ sPrice +"&sFinal="+ sFinal +"&addgayloard=yes",true);
		xmlhttp.send();
	}
	...
	{  
		...
		xmlhttp.open("POST","box_quoting_mrg_mysqli.php?ID="+companyid+"&inventoryIDs="+inventoryids+"&addgayloardMultiple=yes",true);
		xmlhttp.send();
	}
	...
	function popup_general_update(frm, flg, transid, warehouse_id) 
	{
		...
		document.getElementById("popup_window").innerHTML = "<br/>Updating .....<img src='images/wait_animated.gif' />" + document.getElementById("popup_window").innerHTML; 				
		...
		xmlhttp.open("GET","loop_popup_general_update.php?warehouse_id="+ warehouse_id + "&rec_id="+ transid +"&hd_frm_orderissue_frm="+frm+"&hd_frm_orderissue_flg="+flg+"&hd_frm_orderissue_transid="+transid+"&hd_frm_orderissue_warehouse_id="+warehouse_id+"&frm_orderissue_notes="+notesdata+"&est_cost="+est_cost+"&revenue_loss="+revenue_loss+"&reason="+reason+"&vendorsolution="+vendorsolution,true);    // new variable also passed.			
		xmlhttp.send();		
	}
	...
	{ 
       ...
       if(flg==2){
		...
		xmlhttp.open("GET","quote_request_shipping_match_all.php?ID="+id+"&boxid="+boxid+"&display-allrec="+flg,true);			
		xmlhttp.send();
	}	
	...
	{ 
		...
		sstr = sstr + "<tr align='center'>";
		sstr = sstr +  "<td bgcolor='#FF9900'>";
		sstr = sstr + "<font face='Arial, Helvetica, sans-serif' size='1' color='#333333'>NEW SUPERSACKS MATCHING TOOL</font>"; 
		sstr = sstr + "&nbsp;&nbsp;";
		sstr = sstr + "<a style='cursor:pointer;' href='javascript:void(0)' style='text-decoration:none;color:black' onclick=document.getElementById('light_new_supersacks').style.display='none';document.getElementById('fade').style.display='none'>Close</a><br>";
		sstr = sstr + "</td>";
		sstr = sstr + "</tr>";
		...
		xmlhttp.open("GET","supersacks_matching_tool.php?ID="+id+"&boxid="+boxid+"&display-allrec="+flg,true);			
		xmlhttp.send();
	}		
	...
	{ 
       ...
       //alert(flgs);
		...
		xmlhttp.open("GET","supersacks_matching_tool.php?ID="+id+"&boxid="+boxid+"&display-allrec="+flgs,true);			
		xmlhttp.send();
	}	
	//
	...
	function show_file_inviewer_pos_in_iframe(filename, formtype, ctrlnm, iframectrl){
		...
		document.getElementById("light").innerHTML = "<a href='javascript:void(0)' onclick=document.getElementById('light').innerHTML='';document.getElementById('light').style.display='none';document.getElementById('fade').style.display='none'>Close</a> &nbsp;<center>" + formtype +	"</center><br/> <embed src='"+ filename + "' width='800' height='800'>";
		document.getElementById('light').style.display='block';
...
//
	...
	{
		document.location="viewCompany.php?ID="+id+"&quote_id="+quote_id;
	}
	...
	cost,vendor,taxable,quantity,quantity_per_pallet,shipfinalvendor,shipfinal, ctrlidcart)
	{
		...
		var lengthInch_min = ""; var lengthInch_max = ""; var widthInch_min = ""; var widthInch_max = "";
		var depthInch_min = ""; var depthInch_max = ""; 
		
		var lengthInch = ""; var lengthNumerator = ""; var lengthDenominator = ""; var widthInch = "";
		var widthNumerator = ""; var widthDenominator = "";  var depthInch = "";  var depthNumerator = ""; 
	...
	function deleterecord(companyid,inventoryid)
	{
		...
		xmlhttp.open("POST","box_quoting_mrg_mysqli.php?ID="+companyid+"&inventoryID="+inventoryid+"&delete=yes",true);
		xmlhttp.send();
	}
	...
	function duplicaterecord(companyid,inventoryid)
	{
		...
		xmlhttp.open("POST","box_quoting_mrg_mysqli.php?ID="+companyid+"&inventoryID="+inventoryid+"&duplicate=yes",true);
		xmlhttp.send();
	}
	...
	function calcualteprofitloss(form, ctrlidcart)
	{
		if (document.getElementById("item_delivery_flg").value == "no") {
			...
			box_quantity = parseFloat(document.getElementById("box_quantity"+ctrlidcart).value);
			bpallet_qty = parseFloat(document.getElementById("bpallet_qty"+ctrlidcart).value);
			fullUnitPr = parseFloat(document.getElementById("fullUnitPr"+ctrlidcart).value);
			halfUnitPr = parseFloat(document.getElementById("halfUnitPr"+ctrlidcart).value);
			qrtrUnitPr = parseFloat(document.getElementById("qrtrUnitPr"+ctrlidcart).value);
			palletUnitPr = parseFloat(document.getElementById("palletUnitPr"+ctrlidcart).value);
	
			ship_ltl = parseFloat(document.getElementById("ship_ltl"+ctrlidcart).value);
			
			qrtQtyCal = (box_quantity/bpallet_qty/4 ) * bpallet_qty;
			qrtQtyCal = qrtQtyCal.toFixed(0);
			qrtQtyCal = Math.ceil(qrtQtyCal);

			box_quantity_half = parseFloat(box_quantity/2); 
			...
			if (ship_ltl == 0){
				...
				if ((qty >= box_quantity_half) && (qty < (box_quantity))){
					//alert("in step 2");
					minfob = halfUnitPr;
				}
				if ((qty >= qrtQtyCal) && (qty < box_quantity_half)){
				//	alert("in step 3");
					minfob = qrtrUnitPr;
				}
				if ((qty >= bpallet_qty) && (qty < qrtQtyCal)){
					//alert("in step 4");
					minfob = palletUnitPr;
				}
				if ((qty < bpallet_qty)){
			...
			minfob_new = Number(minfob).toFixed(2);
			document.getElementById("minfobdiv"+ctrlidcart).innerHTML = "<font face='Arial, Helvetica, sans-serif' size='1' color='#333333'>$ " + minfob_new + "<input value='"+ minfob +"' name='minfob' id='minfob"+ ctrlidcart+ "' type='hidden'>";
			...
			{
				finalcal_1 = parseFloat(finalcal).toFixed(2);
				var finalcal_2 = Number(finalcal_1).toLocaleString('en');				
				document.getElementById("profit"+ctrlidcart).innerHTML = "$" + finalcal_2;
			}
			
			if(val_1 !="" && document.getElementById("profit"+ctrlidcart).innerHTML!="")
			{
				margin_val1 = (finalcal/(qty * salePrice));
				margin_val = margin_val1*100;
				
				margin_val_1 = parseFloat(margin_val).toFixed(2);
				var margin_val_2 = Number(margin_val_1).toLocaleString('en');				
				
				document.getElementById("margin"+ctrlidcart).innerHTML = margin_val_2;
			}
			...
			margin_target30 = parseFloat(margin_target30);
			min_delv_cost = parseFloat(min_delv_cost);
			salePrice = parseFloat(salePrice);
			
			//alert("values " + qty + "|" + salePrice + "|" + margin_target30 + "|" + min_delv_cost + "|" + box_quantity +  "|" + box_quantity_half + "|" + fullUnitPr + "|" + halfUnitPr + "|" + qrtrUnitPr + "|" + palletUnitPr + " = " + bpallet_qty );

			if (margin_target30 <= min_delv_cost){
				if (salePrice >= min_delv_cost){ 
					document.getElementById("margin_target_cost"+ctrlidcart).innerHTML = "<font face='Arial, Helvetica, sans-serif' size='1' color='green'>See Min FOB Target</font>";
				}else{
					document.getElementById("margin_target_cost"+ctrlidcart).innerHTML = "<font face='Arial, Helvetica, sans-serif' size='1' color='red'>See Min FOB Target</font>";
				}
			
			}else{
				if (salePrice >= margin_target30){ 
					document.getElementById("margin_target_cost"+ctrlidcart).innerHTML = "<font face='Arial, Helvetica, sans-serif' size='1' color='green'>$" + margin_target30 + "</font>";
				}else{
					document.getElementById("margin_target_cost"+ctrlidcart).innerHTML = "<font face='Arial, Helvetica, sans-serif' size='1' color='red'>$" + margin_target30 + "</font>";
				}
			}
		}	
	}
	...
	function show_file_inviewer_pos_in_iframe(filename, formtype, ctrlnm, iframectrl){
		...
		document.getElementById("light").innerHTML = "<a href='javascript:void(0)' onclick=document.getElementById('light').innerHTML='';document.getElementById('light').style.display='none'>Close</a> &nbsp;<center>" + formtype +	"</center><br/> <embed src='"+ filename + "' width='800' height='800'>";
		document.getElementById('light').style.display='block';
	...
	{ 
		...
		var skillsSelect = document.getElementById(iframectrl).contentWindow.document.getElementById("quote_status"+quote_id);
		...
		var quote_status_brought_where = "";
		var quote_status_brought_how_much = "";
		var quote_status_other = "";
		quote_other_details = "";
		if (document.getElementById(iframectrl).contentWindow.document.getElementById("quote_status_brought_where"+quote_id)){
			if (document.getElementById(iframectrl).contentWindow.document.getElementById("quote_status_brought_where"+quote_id).style.display != "none"){
				quote_other_details = "1";
				quote_status_brought_where = document.getElementById(iframectrl).contentWindow.document.getElementById("quote_status_brought_where"+quote_id).value;
			}	
		}
		if (document.getElementById(iframectrl).contentWindow.document.getElementById("quote_status_brought_how_much"+quote_id)){
			quote_status_brought_how_much = document.getElementById(iframectrl).contentWindow.document.getElementById("quote_status_brought_how_much"+quote_id).value;
		}
		if (document.getElementById(iframectrl).contentWindow.document.getElementById("quote_status_other"+quote_id)){
			if (document.getElementById(iframectrl).contentWindow.document.getElementById("quote_status_other"+quote_id).style.display != "none"){
				quote_other_details = "2";
				quote_status_other = document.getElementById(iframectrl).contentWindow.document.getElementById("quote_status_other"+quote_id).value;
			}	
		}
		...
		if(selectedText == 10)
		{
			xmlhttp.open("POST","fckeditor_reminder_email.php?unq_quote_id="+unq_quote_id+"&quote_id="+quote_id+"&quote_status="+selectedText+"&companyid="+id+"&B1=B1"+"&rec_type="+rec_type  + "&quote_status_brought_where="+ encodeURIComponent(quote_status_brought_where) + "&quote_status_brought_how_much="+ encodeURIComponent(quote_status_brought_how_much) + "&quote_status_other="+ encodeURIComponent(quote_status_other) + "&quote_other_details="+ quote_other_details,true);
		}else if(selectedText == 8){
			xmlhttp.open("POST","createpo_from_quote.php?unq_quote_id="+unq_quote_id+"&quote_id_org="+quote_id+"&quote_status="+selectedText+"&companyid="+id+"&B1=B1"+"&rec_type="+rec_type  + "&quote_status_brought_where="+ encodeURIComponent(quote_status_brought_where) + "&quote_status_brought_how_much="+ encodeURIComponent(quote_status_brought_how_much) + "&quote_status_other="+ encodeURIComponent(quote_status_other) + "&quote_other_details="+ quote_other_details,true);			
		}else{
			xmlhttp.open("POST","updateQuoteStatus_mrg.php?quote_id="+quote_id+"&quote_status="+selectedText+"&B1=B1"  + "&quote_status_brought_where="+ encodeURIComponent(quote_status_brought_where) + "&quote_status_brought_how_much="+ encodeURIComponent(quote_status_brought_how_much) + "&quote_status_other="+ encodeURIComponent(quote_status_other) + "&quote_other_details="+ quote_other_details,true);			
		}
	...
	function show_quote_in_iframe(id,quote_id, iframectrl){
		...
		skillsSelect = document.getElementById(iframectrl).contentWindow.document.getElementById("dup_quote"+quote_id);
        ...
        quoteType_val = document.getElementById(iframectrl).contentWindow.document.getElementById("dup_quoteType"+quote_id).value;
        if(quoteType_val=="PO"){
      ...
      xmlhttp.open("GET","dup_quote_shipdate.php?companyID="+id+"&dup_quote_id="+quote_id+"&quoteType="+quoteType_val+"&quote_billto_add="+quote_billto_add_val+"&quote_sellto_add="+quote_sellto_add_val,true);
	...
	function show_reply_in_iframe(tmpcnt, iframectrl) 
	{
		...
		var getele = document.getElementById(iframectrl).contentWindow.document.getElementById("reminder_details" + tmpcnt);
		...
		document.getElementById("light_details").innerHTML = document.getElementById(iframectrl).contentWindow.document.getElementById("remider_rep_popup" + tmpcnt).innerHTML;
		document.getElementById('light_details').style.display='block';
		document.getElementById('light_details').style.left=n_left + 'px';
	...
	{
		if(document.getElementById("iframe_tbl_generate").contentWindow.document.getElementById('email_div'+temp).style.display =='none'){
			document.getElementById("iframe_tbl_generate").contentWindow.document.getElementById('email_div'+temp).style.display='block';
		}else if(document.getElementById("iframe_tbl_generate").contentWindow.document.getElementById('email_div'+temp).style.display =='block')	{
			document.getElementById("iframe_tbl_generate").contentWindow.document.getElementById('email_div'+temp).style.display='none';
		}
	}
...
<div id="light_gaylord_autoload" class="white_content_gaylord_new"></div>
...
<div id="light_gaylord_v3" class="white_content_gaylord_v3_child"></div>
		...
		<td align="left" valign="middle">
			...
			?>
					...
					<? if($status == "Need Boxes"){ ?>
						<a href="viewCompany.php?ID=<?=$_REQUEST["ID"];?>&proc=View&searchcrit=&show=summary&rec_type=<?=$rec_type;?>">
...
if ($b2bid >0 ) {
	...
	if ($parent_child_flg != "") {
		if ($parent_child_flg == "Parent") {
			$sql_pc = "SELECT count(*) as cnt FROM companyInfo Where status <> 31 and parent_comp_id =" . $b2bid . " and parent_child = 'Child'" ;
...
<a style="color:#0000FF;" href="viewCompany.php?ID=<?=$_REQUEST["ID"];?>&proc=View&searchcrit=&show=Quoting&rec_type=<?=$rec_type;?>">Quoting</a> &nbsp;&nbsp;&nbsp;
<?if ($recfound == "no") 
{}
else
{?>
<a style="color:#0000FF;" href="viewCompany.php?ID=<?=$_REQUEST["ID"];?>&proc=View&searchcrit=&show=transactions&rec_type=<?=$rec_type;?>">Transactions</a> &nbsp;&nbsp;&nbsp;
<?}?>
<a style="color:#0000FF;" href="viewCompany.php?ID=<?=$_REQUEST["ID"];?>&proc=View&searchcrit=&show=accounting&rec_type=<?=$rec_type;?>">Accounting</a> &nbsp;&nbsp;&nbsp;
<? if($status == "Have Boxes"){?>
	<a style="color:#0000FF;" href="viewCompany.php?ID=<?=$_REQUEST["ID"];?>&proc=View&searchcrit=&show=watertransactions&rec_type=<?=$rec_type;?>">Water</a> &nbsp;&nbsp;&nbsp;
<? }?>	

<a style="color:#0000FF;" href="viewCompany.php?ID=<?=$_REQUEST["ID"];?>&proc=View&searchcrit=&show=recycling&rec_type=<?=$rec_type;?>">Recycling</a> &nbsp;&nbsp;&nbsp;
...
//if ($parent_child_flg != "") {
?>
 <a style="color:#0000FF;" href="viewCompany.php?ID=<?=$_REQUEST["ID"];?>&proc=View&searchcrit=&show=parentchild&rec_type=<?=$rec_type;?>">Family Tree <? echo $parent_child_cnt; ?></a> &nbsp;&nbsp;&nbsp;
<? //}?> 
	...
	<?
	 ...
	 { 
		...
		if ($rec_found == "yes") {
	?>
			<a style='color:#0000FF;' target="_blank" href="<? echo $dash_link;?>"><font color="blue">View Supplier Dashboard</font></a>
	<?
			}
?>
		&nbsp;&nbsp;<a style='color:#0000FF;' href="viewCompany.php?ID=<?=$_REQUEST["ID"];?>&proc=View&searchcrit=&show=freightsetup&rec_type=<?=$rec_type;?>"><font color="blue">Inbound Freight Setup</font></a>
<?	 }
...
?>
	&nbsp;&nbsp;<a style="color:#0000FF;" href="viewCompany.php?ID=<?=$_REQUEST["ID"];?>&proc=View&searchcrit=&show=Opportunity&rec_type=<?=$rec_type;?>">Opportunities<?=$opp_rec;?></a> &nbsp;
	
	&nbsp;&nbsp;<a style="color:#0000FF;" href="viewCompany.php?ID=<?=$_REQUEST["ID"];?>&proc=View&searchcrit=&show=campaign&rec_type=<?=$rec_type;?>">Campaign <?=$camp_rec;?></a> &nbsp;&nbsp;	
<br><br>
<?
...
<table border="0">
	...
	?>
		<iframe frameborder="0" scrolling="auto" onload="resizeIframe(this)" style="border: none;" height="1000" 
			class="show_iframe" id="show_opportunity" src="viewCompany_opportunity.php?ID=<? echo $_REQUEST['ID']; ?>&show=<? echo $_REQUEST['show']; ?>&rec_type=<? echo $_REQUEST['rec_type'];?>"></iframe>
	...
	?>
		<iframe frameborder="0" scrolling="auto" onload="resizeIframe(this)" style="border: none;" height="1000" 
			class="show_iframe" id="show_opportunity" src="viewCompany_opportunityTask.php?ID=<? echo $_REQUEST['ID']; ?>&show=<? echo $_REQUEST['show']; ?>&rec_type=<? echo $_REQUEST['rec_type'];?>"></iframe>
	
	<?
	
	}elseif($_REQUEST["show"] == "campaign"){

	?>
		<iframe frameborder="0" scrolling="auto" onload="resizeIframe(this)" style="border: none;" height="1000" 
			class="show_iframe" id="show_campaign" src="viewCompany_campaign.php?ID=<? echo $_REQUEST['ID']; ?>&show=<? echo $_REQUEST['show']; ?>&rec_type=<? echo $_REQUEST['rec_type'];?>"></iframe>
	
	<?	
	
	}elseif($_REQUEST["show"] == "campaignTask"){

	?>
		<iframe frameborder="0" scrolling="auto" onload="resizeIframe(this)" style="border: none;" height="1000" 
			class="show_iframe" id="show_campaign" src="campaignTask.php?ID=<? echo $_REQUEST['ID']; ?>&show=<? echo $_REQUEST['show']; ?>&rec_type=<? echo $_REQUEST['rec_type'];?>"></iframe>
		...
		<tr>
					...
					<table cellSpacing="1" cellPadding="1" border="0" style="width: 750px" >
						<tr>
							<td valign="top" align="center" bgColor="#c0cdda">
								<span  style="text-align:middle;"><font size="1">CRM</font>
									<a href='#' onclick="expand_CRM(1, <?=$id?>, <?=$_REQUEST["ID"]?>, '<?=$rec_type?>', '<?=$_REQUEST["show"]?>'); return false;">Expand</a>/
			...
			?>
					...
					if ($_REQUEST["show"] != "parentchild" && $_REQUEST["show"] != "transactions") {
						?>
						<iframe frameborder="0" scrolling="auto" onload="resizeIframe(this)" style="border: none;" height="1000" 
						class="show_iframe" id="show_crm" src="viewCompany-purchasing_func3.php?id=<? echo $loopid;?>&b2bid=<? echo $b2bid;?>&ID=<? echo $_REQUEST['ID']; ?>&show=<? echo $_REQUEST['show']; ?>&rec_type=<? echo $_REQUEST['rec_type'];?>&show=communications"></iframe>
						<?
					}
	...
	<?}	//show == opportunity else part close      ?>
</table>
...
<table cellSpacing="1" cellPadding="1" width="435" border="0" colspan="8">
	...
	<form METHOD="POST" ENCTYPE="multipart/form-data" action="creditappfile_mrg.php">
		...
		<input type="hidden" name="creditapp_companyID" value="<?=$_REQUEST["ID"];?>">
...
<!-- Display the Pending Invoice details -->
		...
		<tr>
			 ...
			 <td bgColor="#e4e4e4" class="txt_style12" >
				<a href="viewCompany.php?warehouse_id=<?=$dt_view_row["D"];?>&rec_type=Supplier&proc=View&searchcrit=&id=<?=$dt_view_row["D"];?>&rec_id=<?=$dt_view_row["I"];?>&display=buyer_payment">
				<a href="viewCompany.php?ID=<?=$_REQUEST["ID"]?>&show=companyinfo&rec_id=<?=$dt_view_row["I"];?>">				
