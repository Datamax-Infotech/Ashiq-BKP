...
<tr>
    ...
    <td align="right">
		<input type="checkbox" name="showall_emp" id="showall_emp" value="yes" <? if (empty($_REQUEST["showall_emp"])){ } else { echo " checked "; }?> onclick="if(this.checked){this.form.submit()}else{this.form.submit()}" >Show only my record(s)
	</td>
</tr>
	...
	<tr align="center">
		...
		<th bgColor="#C0CDDA" style="height: 16px" align="middle">
			<strong>Quote Date</strong>
			  <font size="1" face="Arial, Helvetica, sans-serif" color="#333333">&nbsp;<a href="<? echo $sorturl; ?>&sort_order_pre=ASC&sort=quote_date"><img src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a href="<? echo $sorturl; ?>&sort_order_pre=DESC&sort=quote_date"><img src="images/sort_desc.png" width="6px;" height="12px;"></a>
			</font> 
		...
		<th bgColor="#C0CDDA" style="height: 16px" align="middle">
			<strong>Quote ID</strong>
			  <font size="1" face="Arial, Helvetica, sans-serif" color="#333333">&nbsp;<a href="<? echo $sorturl; ?>&sort_order_pre=ASC&sort=quote_id"><img src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a href="<? echo $sorturl; ?>&sort_order_pre=DESC&sort=quote_id"><img src="images/sort_desc.png" width="6px;" height="12px;"></a>
			</font> 
		...
		<th bgColor="#C0CDDA" style="height: 16px" align="middle">
			<strong>Company</strong>
			  <font size="1" face="Arial, Helvetica, sans-serif" color="#333333">&nbsp;<a href="<? echo $sorturl; ?>&sort_order_pre=ASC&sort=company_name"><img src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a href="<? echo $sorturl; ?>&sort_order_pre=DESC&sort=company_name"><img src="images/sort_desc.png" width="6px;" height="12px;"></a>
			</font>  
		...
		<th bgColor="#C0CDDA" style="height: 16px" align="middle">
			<strong>Rep</strong>
			  <font size="1" face="Arial, Helvetica, sans-serif" color="#333333">&nbsp;<a href="<? echo $sorturl; ?>&sort_order_pre=ASC&sort=account_owner"><img src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a href="<? echo $sorturl; ?>&sort_order_pre=DESC&sort=account_owner"><img src="images/sort_desc.png" width="6px;" height="12px;"></a>
			</font>  
		  </th>	

		<th bgColor="#C0CDDA" style="height: 16px" align="middle">
			<strong>Last Contact Date</strong>
			  <font size="1" face="Arial, Helvetica, sans-serif" color="#333333">&nbsp;<a href="<? echo $sorturl; ?>&sort_order_pre=ASC&sort=lastcrmdt"><img src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a href="<? echo $sorturl; ?>&sort_order_pre=DESC&sort=lastcrmdt"><img src="images/sort_desc.png" width="6px;" height="12px;"></a>
			</font> 
			</th>	
		...
		<th bgColor="#C0CDDA" style="height: 16px" align="middle">
			 <strong>Quoted <br>FOB <br>Price</strong>
			  <font size="1" face="Arial, Helvetica, sans-serif" color="#333333">&nbsp;<a href="<? echo $sorturl; ?>&sort_order_pre=ASC&sort=qut_price"><img src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a href="<? echo $sorturl; ?>&sort_order_pre=DESC&sort=qut_price"><img src="images/sort_desc.png" width="6px;" height="12px;"></a>
		</th>
		<th bgColor="#C0CDDA" style="height: 16px" align="middle">
			 <strong>Quoted <br>Delivered<br> Price</strong>
			  <font size="1" face="Arial, Helvetica, sans-serif" color="#333333">&nbsp;<a href="<? echo $sorturl; ?>&sort_order_pre=ASC&sort=qut_del_price"><img src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a href="<? echo $sorturl; ?>&sort_order_pre=DESC&sort=qut_del_price"><img src="images/sort_desc.png" width="6px;" height="12px;"></a>
		</th>
		<th bgColor="#C0CDDA" style="height: 16px" align="middle">
			 <strong>Quoted Status</strong>
			  <font size="1" face="Arial, Helvetica, sans-serif" color="#333333">&nbsp;<a href="<? echo $sorturl; ?>&sort_order_pre=ASC&sort=qut_status"><img src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a href="<? echo $sorturl; ?>&sort_order_pre=DESC&sort=qut_status"><img src="images/sort_desc.png" width="6px;" height="12px;"></a>
		</th>
...
if ($_REQUEST["inventoryID"] != "" && (!isset($_REQUEST["sort"]))) {
  ...
  if($numrec>0)
  {
	...
	while($objGBmatch=array_shift($queryb))
	{
		...
		<tr>
			...
			<td> <a href="viewCompany.php?ID=<?=$objGBmatch["companyid"]?>" target="_blank"><?=$nickname;?> </a></td>

			<td> <? echo $objGBmatch["account_owner"];?> </td>

			<td> <? echo $lastcrmdt;?> </td>

			<td> <? echo $acc_status;?> </td>
			
			<td> $<? echo $objGBmatch["quote_price"];?> </td>
			<td> $<? echo $objGBmatch["quoted_delivered_price"];?> </td>
			
			<td> <? echo $objGBmatch["quote_status"];?> </td>
       ...
       <? 
		...
		'quoted_delivered_price' => $objGBmatch["quoted_delivered_price"], 'acc_status' => $acc_status, 'account_owner' => trim($objGBmatch["account_owner"]),'lastcrmemp' => trim($lastcrmemp),'lastcrmdt' => $lastcrmdt,'quote_date' => $quote_date,
 ...
 <? 
	...
	//if ($_REQUEST["employeeID"] > 0) $matchStr = $matchStr . " AND employeeID = " . $_REQUEST["employeeID"];
	...
	while ($objGBmatch = array_shift($res1)){
		...
		while ($quote_rows1= array_shift($dt_view_res3)) 
		{
			...
			$dt_view_res4 = db_query($boxSql,db_b2b() );
			$quote_status = "Open";
			...
			while ($objQStatus= array_shift($dt_view_res4)) {
				...
				//echo $quoteid_rem . " " . $delivery_included . " = " . $objQStatus["salePrice"] . " " . $objQStatus["quantity"] . " " . $objGBmatch["salePrice"] . "<br>";
			}	

			/*
			if (is_null($quote_rows1["quote_total"]) ) {
				$quote_price = 0;
			}else{
				$quote_price = $quote_rows1["quote_total"];
			}
			*/
		...
		//boxes.quantity, boxes.salePrice, boxes.shipfinal
		//--- If has a "Shipping Quote" value entered in the item, then "Quote Price" = (( [Sale Price] * [Quantity] ) - [Shipping Quote] ) / [Quantity]
		//--- Else (no value in "Shipping Quote" for the item), then "Quote Price" = [Sale Price]
		//echo $g_no_of_quote_sent1 . " = " . $objGBmatch["shipfinal"] . " - " . $objGBmatch["salePrice"] . " - " . $objGBmatch["quantity"] . "<br>";
	...
	<tr>
			...
			<td>
			<? 		if (date('m/d/Y',strtotime($quote_date)) == "12/31/1969")			echo "Quote Removed";		else		echo date('m/d/Y', strtotime($quote_date));?>
			</td>
			...
			<td> <? echo $objGBmatch["initials"];?> </td>

			<td> <? echo $lastcrmdt;?> </td>

			<td> <? echo $acc_status;?> </td>
			<td align="right"> $<?echo number_format($quote_price,2);?>
			</td>
			<td align="right"> $<?echo number_format($quoted_delivered_price,2);?>
			<td >
				<? echo $quote_status;?>
			</td>
			</td>
...
$x++;
		...
		$MGArray[] = array('companyID' => $objGBmatch["companyID"], 'company_name' => trim($nickname), 'selltoemail' => trim($objGBmatch["email"]), 'acc_status' => $acc_status, 'account_owner' => trim($objGBmatch["name"]), 'lastcrmemp' => trim($lastcrmemp),'lastcrmdt' => $lastcrmdt,'quote_date' => $quote_date,
...
foreach ($MGArray as $MGArraytmp2) {?>			
    ...
    <?=$MGArraytmp2["g_no_of_quote_sent1"];
    ?>
    </td>

		<td> <a href="viewCompany.php?ID=<?=$MGArraytmp2["companyID"]?>" target="_blank"><?=$MGArraytmp2["company_name"];?> </a></td>

		<td><? echo $MGArraytmp2["account_owner"];?> </td>

		<td> <?=$MGArraytmp2["lastcrmdt"];?></td>

		<td> <?=$MGArraytmp2["acc_status"];?></td>

		<td align="right">$<? echo number_format($MGArraytmp2["quote_price"],2);?></td>
		<td align="right">$<? echo number_format($MGArraytmp2["quoted_delivered_price"],2);?></td>
		
		<td><? echo $MGArraytmp2["quote_status"];?></td>
	</tr>		
...
<?} ?>
	...
	<input type="hidden" name="inventoryID" id="inventoryID" value="<? echo $_REQUEST["inventoryID"]; ?>"/>

	<input type="hidden" name="employeeID" id="employeeID" value="<? echo $_REQUEST["employeeID"]; ?>"/>

	<input type="hidden" name="sort" id="sort" value="lastcrmdt"/>

	<input type="hidden" name="sort_order_pre" id="sort_order_pre" value="<? echo $sort_order_pre; ?>"/>
